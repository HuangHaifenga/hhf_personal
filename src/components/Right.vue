...
<template>
  ...
  <div id="right">
    ...
    <div v-if="!isHideTime" class="right-display">
      <div v-if="!isHideAWord" class="right-display-aWord card" @click="getAWord">
    ...
    <div class="right-separate">
      <svg class="right-separate-svg" data-v-6b5f55f6="" viewBox="0 0 512 512"
